# Bundled subagents (shared scope)

Built-in functional subagents shipped with pi-shepherd, in the **cross-tool /
...
The same durable, no-fuss subagents ship in `.pi/agents/` too; the two dirs
