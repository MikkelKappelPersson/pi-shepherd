...
assert.equal(
  byName.shepherd_wait,
  undefined,
  'blocking shepherd_wait is removed from the public surface'
);
...
const handoffPath = fileURLToPath(
  new URL('../docs/specs/005-agent-messaging-and-task-lifecycle/handoff.md', import.meta.url)
);
