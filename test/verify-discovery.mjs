...
assert(omitPiDocs?.omitPiDocumentation === true, "frontmatter: omitPiDocumentation true is retained");
assert(user.agents.find((a) => a.name === "only-user")?.omitPiDocumentation === false, "frontmatter: omitPiDocumentation defaults false");
assert(omitContextTrue?.omitContextFiles === true, "frontmatter: omitContextFiles strict true is retained");
assert(omitContextFalse?.omitContextFiles === false, "frontmatter: omitContextFiles strict false is retained");
assert(omitContextInvalid?.omitContextFiles === false, "frontmatter: omitContextFiles quoted true is ignored");
assert(omitContextAbsent?.omitContextFiles === false, "frontmatter: omitContextFiles defaults false");
